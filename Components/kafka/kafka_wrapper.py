...
def main():
    ...
    kafka.produce_message("I am very happy!!!!") 
    kafka.produce_message("I am very sad!!!!") 
    kafka.produce_message("I am very excited about the game!!!!") 
    kafka.produce_message("I am very disapointed with his performance!!!!") 
    kafka.produce_message("I am super excited about that new movie!!!!") 
    kafka.produce_message("I am very happy!!!!") 
    kafka.produce_message("I am very sad!!!!") 

    kafka.wait_and_consume_messages()
